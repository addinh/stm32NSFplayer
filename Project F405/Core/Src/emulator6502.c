...
BYTE		pROM_Full[MAX_ROM_SIZE];		//Full ROM buffer
...
const BYTE CPU_Cycles[0x100] = {		//the number of CPU cycles used for each instruction
...
const BYTE NZTable[0x100] = {		//the status of the NZ flags for the given value
